...
IBD_r=v[41]
Norm_geo=v[42]/IBD_r*Ntot
Norm_acc=v[43]/IBD_r*Ntot
Norm_Li9=v[44]/IBD_r*Ntot
Norm_fn=v[45]/IBD_r*Ntot
Norm_alpha=v[46]/IBD_r*Ntot
...
Bg_tot=Bg_acc+Bg_alpha+Bg_fn+Bg_geo+Bg_Li9
...
for i in range(0,M):
    ...
    def least_squares_syst(T13, T12, M21, M3l, ord, N, A, B, C,alpha_C,alpha_D,a_R1,a_R2,a_R3,a_R4,a_R5,a_R6,a_R7,a_R8,a_R9,\
        ...
        z_num=(yMis-yT*(1+alpha_C+alpha_D+weig_sum)-Bg_geo*(1+alpha_B1)-Bg_acc*(1+alpha_B2)-Bg_alpha*(1+alpha_B3)-Bg_fn*(1+alpha_B4)-Bg_Li9*(1+alpha_B5))**2
        z_den=yMis+(sigma_b2b*yT)**2+(sigma_sh_geo*Bg_geo)**2+(sigma_sh_acc*Bg_acc)**2+(sigma_sh_alpha*Bg_alpha)**2+(sigma_sh_fn*Bg_fn)**2+(sigma_sh_Li9*Bg_Li9)**2
        ...
        pull_bkg=(alpha_B1/sigma_B_geo)**2+(alpha_B2/sigma_B_acc)**2+(alpha_B3/sigma_B_alpha)**2+(alpha_B4/sigma_B_fn)**2+(alpha_B5/sigma_B_Li9)**2
        return CHI+pull_a+pull_b+pull_c+pull_syst+pull_syst_cores+pull_bkg
    least_squares_syst.errordef = Minuit.LEAST_SQUARES

    #Fit NO on NO
    m = Minuit(least_squares_syst, T13=Theta13_NO,T12=Theta12+0.152,M21=DeltaM21,M3l=DeltaM31_NO, ord=1, N=Ntot,A=a,B=b,C=c,alpha_C=0,alpha_D=0,\
        a_R1=0, a_R2=0, a_R3=0, a_R4=0, a_R5=0, a_R6=0, a_R7=0, a_R8=0, a_R9=0, alpha_B1=0,alpha_B2=0,alpha_B3=0,alpha_B4=0,alpha_B5=0)
    ...
    #Fit IO su NO
    n = Minuit(least_squares_syst, T13=Theta13_IO,T12=Theta12+0.152,M21=DeltaM21,M3l=DeltaM32_IO, ord=0, N=Ntot,A=a,B=b,C=c,alpha_C=0,alpha_D=0, \
        a_R1=0, a_R2=0, a_R3=0, a_R4=0, a_R5=0, a_R6=0, a_R7=0, a_R8=0, a_R9=0, alpha_B1=0,alpha_B2=0,alpha_B3=0,alpha_B4=0,alpha_B5=0)
